const colors = {
  green: {
    wrapperBackground: "#8AFFBA",
    headerBackground: "#00B90E",
    headerColor: "black",
    photoBorderColor: "#black"
  },
  blue: {
    wrapperBackground: "#C9EDFF",
    headerBackground: "#00AAFF",
    headerColor: "white",
    photoBorderColor: "#0044C2"
  },
  pink: {
    wrapperBackground: "#F5A0FF",
    headerBackground: "#FF00E4",
    headerColor: "white",
    photoBorderColor: "#FEE24C"
  },
  red: {
    wrapperBackground: "#FF9C9C",
    headerBackground: "#DA0000",
    headerColor: "white",
